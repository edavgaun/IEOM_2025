...
def semmantic_drift_plot_plotly(region, year, tf_dfs, tf_idfs,
    ...
    # Quadrant titles
    fig.add_annotation(xref="paper", yref="paper", x=0.4, y=0.99, text="Rare but Telling",
    ...
    fig.add_annotation(xref="paper", yref="paper", x=0.425, y=0.075, text="Noise",
                       font=dict(size=fz, color='#7f7f7f'), showarrow=False)
    fig.add_annotation(xref="paper", yref="paper", x=0.95, y=0.075, text="Generic but Common",
                       font=dict(size=fz, color='#1f77b4'), showarrow=False)

    # Axis-side labels
    fig.add_annotation(xref="paper", yref="paper", x=0.075, y=-0.025,
                       text="Low<br>Frquency<br>Tokens", showarrow=False,
                       font=dict(size=fz-2, color='#7f7f7f'), align='center')
    fig.add_annotation(xref="paper", yref="paper", x=0.975, y=-0.025,
